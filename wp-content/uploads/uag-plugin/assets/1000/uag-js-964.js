document.addEventListener("DOMContentLoaded", function(){ jQuery(document).ready(function () {
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-d172bd02");
				if ( scope.length ) { 
				...
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-ae7f760c");
				if ( scope.length ) { 
					scope.css("visibility", "visible");
					let getSlickCarousel = scope.find(".uagb-slick-carousel");
					if( getSlickCarousel.length ) {
				...
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-bfceadd3");
				if ( scope.length ) { 
					scope.css("visibility", "visible");
					let getSlickCarousel = scope.find(".uagb-slick-carousel");
					if( getSlickCarousel.length ) {
