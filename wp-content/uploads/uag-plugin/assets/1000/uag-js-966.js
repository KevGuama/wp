document.addEventListener("DOMContentLoaded", function(){ jQuery(document).ready(function () {
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-cb714af9");
				if ( scope.length ) { 
				...
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-332259e9");
				if ( scope.length ) { 
					scope.css("visibility", "visible");
					let getSlickCarousel = scope.find(".uagb-slick-carousel");
					if( getSlickCarousel.length ) {
				...
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-94a10e66");
				if ( scope.length ) { 
					scope.css("visibility", "visible");
					let getSlickCarousel = scope.find(".uagb-slick-carousel");
					if( getSlickCarousel.length ) {
